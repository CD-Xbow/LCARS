...
I took the guts of it and made it into an include - CustomButtons.pbi
See below
...
This example uses CustomButtons.pbi to make 7 rounded button similar to the Star Trek LCARS in form & color

Next examples require a font and an image 

The LCARS font is from https://www.opendesktop.org/p/998508
The graphic will be in the zip at github
