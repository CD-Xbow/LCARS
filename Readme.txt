...
This example uses CustomButtons.pbi to make 7 rounded button similar to the Star Trek LCARS
in form & color

Next examples require a font and an image which are in the Repo
